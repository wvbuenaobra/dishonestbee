...
$new_order_query = "INSERT INTO orders(user_id, transaction_code, status_id, payment_mode_id, total) VALUES ('$user_id', '$trans_code', '$status_id', '$payment_mode_id', '$cart_total');";
